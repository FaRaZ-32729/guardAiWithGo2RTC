...
//     // Determine source and component
...
// // Fullscreen Modal (Updated to handle both iframe and img)
...
//                         />
//                     ) : (
//                         // IP Camera in fullscreen - keep img
//                         !imgError ? (
//                             <img
//                                 src={streamSrc}
//                                 alt={cam.cameraName}
...
//                     <h1 className="text-white text-xl font-bold tracking-tight">Camera Feed</h1>
//                     <p className="text-slate-500 text-xs mt-0.5">
//                         {cameras.length + 1} cameras total
//                     </p>
//                 </div>
